...
if we look at "North Carolina" and try to get the jazz musician from that state, 
we will find it very difficult to do. Our relationship would give two different outputs: "John Coltrane" and "Thelonious Monk".
...
- If the key matches the one youre looking for, return the value.
- If the keys dont match, continue to the next position depending on your collision strategy.
